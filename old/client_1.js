...
//start game button
document.getElementById("button-start").addEventListener('click', function(games) {
...
//    document.getElementById('topNav').style.display = 'block';
    ...
    for (var x in games) {
        if (games[x].room_id === roomcode) {
            var playerSeats = games[x].players.join("\n");            
        } 
    ...
    document.getElementById("playerList").innerHTML = playerSeats;
});
