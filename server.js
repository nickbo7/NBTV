...
var prompts = ["Success breeds", "Thank you for", "That day was the last time I ever", "_____ will help you grow a nice bushy beard", "And the academy award goes to", "How to tell someone likes you", "A losing campaign slogan:", "A winning campaign slogan:", "You never know what you can do until you", "If you think you are too small to make a difference, you haven't", "Where we're going, we don't need", "Only a fool tests the depth of water with", "It takes a village to raise", "Loose lips sink", "A man who chases two rabbits catches", "Nothing is impossible for", "If you do good, _____ will be done to you", "A wise man makes his own decisions, and an ignorant man", "To try and to fail is", "A fool says what he knows, and a wise man", "There is too much _____ in the world.", "I am protesting against", "If I've learned one thing in life, it is", "Would you like _____ with that?", "The coolest thing about the future will be", "If it wasn't for _____, I wouldn't be here today.", "I was a professional _____ at the age of 10", "Please don't", "The biggest threat to humanity is actually", "L.O.L. stands for", "As punishment for your crimes, you are sentenced to", "To reduce poverty, we just need to", "If I win the lottery, I will spend the money on", "For my Birthday, I'm asking for", "H.O.M.E. stands for", "L.O.V.E. stands for", "The greatest pleasure in life is", "I am strong, I am worthy, I am", "When life knocks you down,", "The virus that wiped out the Internet was called", "My last words were", "The 28th amenment to the U.S. Constitution will grant citizens the right to", "It takes 900 licks to get to the center of", "It's pretty cool that you like", "I was once in a band called", "Last time you did that, I _____ for days", "My biggest fear is", "It's nice when people", "In 100 years, everyone will eat", "My doctor told me _____ will fix my issue", "If you ever go to New York, be sure to check out", "What happened to you?", "I once spent my life savings on", "I could vote for _____ if they run for President", "Which way is it to"];
var games = [];
var players = {};
var t; //voting timer
var sb; //scoreboard timer
...
function timer(ms, room) {
    sb = setTimeout(nextRound, ms, room);
    var time = 46.5; //50 ~= 5 sec, 300 ~= 30 sec 
    io.to(room).emit('timerStart', time);
}
...
io.on('connection', function (socket) {
    ...
    var port = socket.request.connection.remoteAddress.port;
